...
<body>
    <div class="max-width" style="background-color: var(--w); position: absolute; left: 20%;">
        <div class="top"
            ...
            <div class="right"><a class="lecturerBtn" href='admindashboard.php?info=add_teacher'><svg
        ...
        <div class="bottom">
            <table class='table-striped'>
                ...
                echo "<td>
                    <abbr title='update'>
                        <a href='admindashboard.php?info=updateteacher&teacher_id=". $row["teacher_id"] . "'>
                ...
                echo"<td>
                    <abbr title='delete'>
                        <a href='javascript:deleteData(". $row["teacher_id"] . ")'>
                            <svg width='23' height='23' viewBox='0 0 15 15' fill='none'
