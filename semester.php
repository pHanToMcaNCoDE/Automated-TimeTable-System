...
<body>
    <div class="max-width" style="background-color: var(--w); position: absolute; left: 21%; top: 10%;">
        <div class=" top"
            ...
            <div class="right">
                <a class="lecturerBtn" href='admindashboard.php?info=add_semester'>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
	...
	$sql1 = "SELECT department_name FROM department where department_id='".$row['department_id']."'";
	$result1 = $con->query($sql1);
	$row1 = $result1->fetch_assoc();
  	echo "<td>".$row1["department_name"]."</td>";
	echo "<td>
            <abbr title='update'>
                <a href='admindashboard.php?info=updatesemester&sem_id=".$row["sem_id"]."'>
                    <svg width='23' height='23' viewBox='0 0 15 15' fill='none'
                        xmlns='http://www.w3.org/2000/svg' style='margin-right: 8%; color: var(--g);'>
                        <path
        ...
        echo"<td>
            <abbr title='delete'>
                <a href='javascript:deleteData(".$row["sem_id"].")'>
                    <svg width='23' height='23' viewBox='0 0 15 15' fill='none'
                        xmlns='http://www.w3.org/2000/svg' style='margin-left: 8%; color: var(--cr);'>
                        <path
  	...
  	// echo "<td><a href='admindashboard.php?info=updatesemester&sem_id=".$row["sem_id"]."'>Update</a></td>";
  	// echo "<td><a href='javascript:deleteData(".$row["sem_id"].")'>Delete</a></td>";
  	echo "</tr>";
  }
} else {
  echo "0 results";
