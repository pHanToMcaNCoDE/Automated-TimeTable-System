...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <div class="row" align="center" style="display: flex; justify-content: space-between; align-items: center;">
                <div class="left" style="width: 50%;">
                    <h2>A.T.T.S</h2>
                    <p>Automated Timetable System</p>
                </div>
                <div class="col-md-5" style="width: 50%;" align="center">
