...
if (isset($update)) {
    ...
    mysqli_query($con, "update subject set subject_id='$subid', subject_name='$subname', level='$lvl', sem_id='$s',department_id='$course', teacher_id='$t', lecture_per_week='$lpw', type='$type' where subject_id='$subject_id' ");
...
?>
   ...
   <tr>
    ...
    <td width="213"><input type="text" name="subid" class="form-control" value="<?php echo $res['subject_id']; ?>"/></td>
  </tr>
   <tr>
  ...
  <tr>
    <th width="237" scope="row">Select Level</th>
    <td width="213">
...
<input type="submit" value="Update Records" name="update"/>
    ...
    <th colspan="1" scope="row" align="">
      <a href="admindashboard.php?info=subject">Go Back</a>
    </th>
  </tr>
</table>
</form>
